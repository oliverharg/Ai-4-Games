...
(function($) {
	...
	me.loader = (function() {
		...
		function preloadTMX(tmxData, onload, onerror) {
			console.warn("tmxData", tmxData);
			console.warn("me.nocache", me.nocache);
			console.warn("onerror function", onerror);
			...
			xmlhttp.onreadystatechange = function() {
				...
				if (xmlhttp.readyState==4) {
					...
					if ((xmlhttp.status==200) || ((xmlhttp.status==0) && xmlhttp.responseText)){
						...
						// add the tmx to tse levelDirector
						if (tmxData.type === "tmx") {
			...
			// send the request
			console.warn("Sending xmlhttp request...", xmlhttp);
			xmlhttp.send(null);
		};
